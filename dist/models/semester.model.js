...
var semesterSchema = new mongoose_1.Schema({
    title: {
        type: String,
        required: true,
...
semesterSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Semester.findOne({ title: this.title, year: this.year })];
                case 1:
                    isExist = _a.sent();
                    if (isExist) {
...
var Semester = (0, mongoose_1.model)('Semester', semesterSchema);
